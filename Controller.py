    ...
    def alterarCategoria(self, categoriaAlterar, categoriaAlterada):
        ...
        if len(cat) > 0:
            ...
            if len(cat1) == 0:
                ...
                # Alterar também a categoria no estoque
            else:
    ...
    def cadastrarProduto(self, nome, preco, categoria, quantidade):
        ...
        if len(h) > 0:
            if len(est) == 0:
                ...
                print('Produto já está cadastrado no estoque')
        else:
        ...
        if len(h) > 0:
            ...
            if len(est) > 0:
                ...
                if len(est) == 0:
                    ...
                    print('O produto que deseja incluir já existe') 
            else:
...
class ControllerVenda:
    def cadastrarVenda(self, nomeProduto, vendedor, comprador, quantidadeVendida):
        ...
        if existe == False:
            ...
            print('A quantidade vendida não tem estoque disponível')
            return None
        else:
    ...
    def relatorioProdutos(self):
        ...
        ordenado = sorted(produtos, key=lambda k: int(k['quantidade']), reverse=True)
...
class ControllerFornecedor:
    ...
    def alterarFornecedor(self, nomeAlterar, novoNome, novoCnpj, novoTelefone, novoCategoria):
        ...
        if len(est) > 0:
            ...
            print('Não foi encontrado o fornecedor que deseja alterar')
    ...
    def mostrarFornecedores(self):
        ...
        if len(fornecedores) > 0:
            ...
            print('Cadastro de fornecedores vazio')
...
class ControllerCliente:
    ...
    def alterarCliente(self, nomeAlterar, novoNome, novoTelefone, novoCpf, novoEmail, novoEndereco):
        ...
        if len(est) > 0:
            ...
            print('Pessoa que deseja alterar não foi encontrada')
    ...
    def removerCliente(self, nome):
        ...
        if len(est) > 0:
            ...
            print('O cliente que deseja remover não existe no cadastro')
            return None
...
class ControllerFuncionario:
        ...
        if len(listaCpf) == 0:
            if len(listaClt) == 0:
                if len(cpf) == 11 and len(telefone) >= 10 and len(telefone) <= 11:
                    ...
                    print('Inclua um CPF ou telefone válido')
            else:
                print('Já existe um funcionário cadastrado com essa CLT')
        else:
    ...
    def alterarFuncionario(self, nomeAlterar, novoClt, novoNome, novoTelefone, novoCpf, novoEmail, novoEndereco):
        ...
        if len(est) > 0:
            ...
            print('Não existe o funcionário que deseja alterar') 
    ...
    def removerFuncionario(self, nome):
        ...
        if len(est) > 0:
            ...
            print('O funcionário que deseja excluir não foi encontrado')
    ...
    def mostrarFuncionarios(self):
        ...
        if len(x) > 0:
            ...
            print('Não existem funcionários a ser exibidos')
